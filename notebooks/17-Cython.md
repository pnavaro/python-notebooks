...
```cython slideshow={"slide_type": "slide"} magic_args="-a"
...
```cython slideshow={"slide_type": "fragment"} magic_args="-a"
cdef int m, n
...
```cython slideshow={"slide_type": "fragment"}
def f(x):
    return -4*x**3 +3*x**2 +2*x
...
```cython slideshow={"slide_type": "skip"}
...
```cython slideshow={"slide_type": "slide"}
import numpy as np
cimport numpy as np
...
```cython slideshow={"slide_type": "fragment"} magic_args="-I {here}"
